package com.joker.lpgo.utils.widget.edittext
...
import com.joker.lpgo.utils.AppDimensionsUtils
import com.joker.lpgo.utils.extension.show
 ...
 *
 * Created by Hidayat 20/10/20 16.12
 * hidayat@bts.id
 */
...
class AppEditTextView : FrameLayout {
    ...
    fun setMaxLength(maxLength: Int) {
        edt_phone.filters = arrayOf<InputFilter>(LengthFilter(maxLength))
    }
    ...
    fun setOnEditorActionListener(listener: OnEditorActionListener) {
        edt_phone.setOnEditorActionListener(OnEditorActionListener { v, actionId, event ->
